...
class AddVariantScreen extends StatefulWidget {
  ...
  const AddVariantScreen({super.key, required this.character});
...
class _AddVariantScreenState extends State<AddVariantScreen> {
  ...
  Future<void> _pickCharacterFile() async {
    final result = await FilePicker.platform.pickFiles(
      ...
      dialogTitle: 'Select variant character file',
    );
  ...
  Future<void> _save() async {
    ...
    try {
      await context.read<CharacterProvider>().addVariant(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Add variant — ${widget.character.name}'),
      ),
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration: const InputDecoration(
                          hintText:
                              'e.g. Summer look, Battle outfit, Alt race…'),
                      validator: (v) =>
